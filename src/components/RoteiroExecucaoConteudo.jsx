...
// tanto na pagina cheia (/roteiros/:id/executar) quanto dentro de um card do
// Dashboard (PainelFuncionarioTodasLojas). Mesma logica, mesmos endpoints -
// so a moldura de pagina (Navbar/Footer/max-w) fica fora daqui.
export function RoteiroExecucaoConteudo({ roteiroId }) {
  const id = roteiroId;
